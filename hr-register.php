...
<head>
  ...
  <title>Register as HR - MWC RECORD-KEEPING SYSTEM</title>
...
<body>
  ...
  <main class="register-section">
    <div class="register-content">
      ...
      <form action="" method="POST" class="register-form">
        ...
        <button type="submit" name="register_hr" class="btn-submit">Register</button>
      </form>
    </div>
  </main>
  ...
  if (isset($_POST['register_hr'])) {
      ...
      if ($_POST['password'] !== $_POST['confirm_password']) {
          ...
          // Insert query
          $sql = "INSERT INTO hr (first_name, last_name, email, password, phone) VALUES ('$first_name', '$last_name', '$email', '$password', '$phone')";

          if ($conn->query($sql) === TRUE) {
              // Redirect to HR dashboard on successful registration
