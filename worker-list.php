...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul>
            ...
            <li><a href="supervisor-report.php"><i class="fas fa-file-download"></i>Generate Report</a></li>
        </ul>
    </div>
                    ...
                    <?php
                        if ($result && $result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . htmlspecialchars($department) . "</td>"; // Display formatted department name
